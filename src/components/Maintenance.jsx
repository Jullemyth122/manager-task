...
const MaintenanceBoard = () => {
    ...
    const finalFilteredAccounts2 = useSearchFilter(accs, searchTask, [
        'username',
        'email',
    ]);
                            ...
                            <div className="lists-tsm">
                                <div className="table-container">
                                    <table>
                                        ...
                                        <tbody>
                                            {finalFilteredAccounts2.map(acc => {
